...
df = pd.read_csv("../../../data/Gluc_barcodes.csv")
...
def run(gene):
    db = "../../../data/mpathic_footprints/20221114_barcode/{}_Gluc_dataset_db".format(gene)
    ...
    mcmc_df.to_csv("footprints/Gluc_{}_mcmc_mpathic2.csv".format(gene))
