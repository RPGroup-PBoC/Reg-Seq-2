...
df = pd.read_csv("g260_barcodes.csv")
...
def run(gene):
    db = "../../../data/mpathic_footprints/20230327_barcode/{}_g260_dataset_db".format(gene)
    ...
    mcmc_df.to_csv("footprints/g260_{}_mcmc_mpathic2.csv".format(gene))
