...
df = pd.read_csv("p88_barcodes.csv")
...
def run(gene):
    db = "../../../data/mpathic_footprints/20230327_barcode/{}_p88_dataset_db".format(gene)
    ...
    mcmc_df.to_csv("footprints/p_88_{}_mcmc_mpathic2.csv".format(gene))
