...
RAW_DIR = INPUT_DIR + '220414_M05340_0333_000000000-DGCJB/Data/Intensities/BaseCalls/'
...
FORWARD_STR = 'Undetermined*R1*_rc.fastq.gz'
REVERSE_STR = 'Undetermined*R2*_rc.fastq.gz'
