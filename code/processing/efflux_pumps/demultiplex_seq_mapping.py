...
INPUT_DIR = f'{homedir}/data/sequencing/{DESCRIPTION}' 
...
artifact_file = f'{QIIME2_DIR}_sequence_artifact.qza'  # output artifact
...
demux_file = f'{QIIME2_DIR}_demux_artifact.qza'
# File to save the details for the demultiplexed sequences
demux_details = f'{QIIME2_DIR}_demux_details.qza'
...
demux_viz = f'{QIIME2_DIR}_demix_viz.qzv'  
